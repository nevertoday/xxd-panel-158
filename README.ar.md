...
تستخدم النماذج التالية مراجع أصلية مختلفة. أنشأ Panel 158 كل عمل بصورة مستقلة وفي جولة توليد واحدة، وقد أزيلت البيانات الوصفية للذكاء الاصطناعي. النماذج الأفقية تقسيمها صارم 50:50: الواقع يساراً والتصميم يميناً؛ والنماذج العمودية تقسيمها صارم 50:50: الواقع أعلى والتصميم أسفل.
...
القيود الملحوظة: بعض العناصر الرئيسية والمشاهد المحتفظ بها ما زالت كبيرة، وتبدو القصاصات أحياناً زخرفة إضافية بدلاً من بناء الشكل. تتضمن بعض النتائج علامات شبيهة بالتوقيع أو التاريخ لم تُطلب، وليست نسباً إلى فنان أو معلومات واقعية. لم تُجرَ محاولات إضافية.
